...
var _utils = _interopRequireDefault(__webpack_require__(/*! common/utils.js */ 11));
...
_vue.default.prototype.$myRuquest = _request.myRequest;
...
/* 6 */
/*!***********************************************************!*\
  !*** C:/HXDemo/jiashili/App.vue?vue&type=script&lang=js& ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  onLaunch: function onLaunch() {var _this = this;
    uni.getSystemInfo({
      success: function success(res) {
        ...
        uni.setStorageSync("windowHeight", 750 / res.windowWidth * res.windowHeight * 1);
      } });

    uni.getSetting({
      success: function success(res) {
        console.log("初始加载", res);
        if (!res.authSetting["scope.userInfo"]) {
          // 没有授权过
          console.log("没有授权过");
          // 还没有授权，就是第一次授权
          _this.$utils.setData("isFirstUse", true);
        } else {
          _this.$utils.setData("isFirstUse", false);
        }
      } });
...
/* 8 */
/*!********************************************************************!*\
  !*** C:/HXDemo/jiashili/App.vue?vue&type=style&index=0&lang=scss& ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
